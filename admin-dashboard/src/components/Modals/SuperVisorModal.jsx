...
const SupervisorModal = ({ title, q1, q2, q3, q4, q5, q6, q7, value, id }) => {
  const { UpdateSupervisorData } = usePostContext();
  ...
  const handleSubmit = async () => {
    await UpdateSupervisorData(updatedData);
    setUpdatedData({
      firstName: "",
      lastName: "",
      email: "",
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <label className=" w-full max-w-xs">
              ...
              <select
                className="input input-bordered w-full max-w-xs"
                onChange={(e) =>
                  setUpdatedData({ ...updatedData, userStatus: e.target.value })
                }
                value={updatedData?.userStatus}
              >
